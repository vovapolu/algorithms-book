...
Про бинарный поиск можно говорить очень долго, этот алгоритм несмотря на свою простоту обладает поистине мощным применением. Сама же идея, которая лежит в основе, тоже является настоящим 
