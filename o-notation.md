...
Что же такое вообще это $$O$$? Не буду повторять учебники мат.анализа, которые вы можете прочитать и сами, лучше вместо этого, я дам не такое строгое, но наглядное представление о таком понятии как асимптотика и $$O$$ большое. 
