...
Что же такое вообще это $$O$$? Не буду повторять учебники мат.анализа, которые вы можете прочитать и сами, вместо этого я дам не такое строгое, но наглядное представление о таком понятии как асимптотика и $$O$$ большое. 
...
###Что дальше?
Этих знаний вам хватит, чтобы полностью понять дальнейшние главы и даже самим вычислять асимптотику многих алгоритмов. Можно начинать читать Давайте уже перейдем к более практичным вещам и рассмотрим еще несколько приемов на конкрентных примерах. 