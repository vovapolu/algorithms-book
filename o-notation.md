...
В конце хотелось мне бы хотелось просто показать значения некоторых из этих функций в точках $$n = 10$$, $$100$$, $$1000$$, $$10^6$$. *(Числа даны не совсем точные, это сделано для понимания размера числа)*
