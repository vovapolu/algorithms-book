...
Что же такое вообще это $$О$$? Не буду повторять учебники мат.анализа, которые вы можете прочитать и сами, вместо этого, я дам не такое строгое, но наглядное представление о таком понятии как асимптотика и $O$ большое. 
