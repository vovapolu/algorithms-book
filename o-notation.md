...
Вот, в общем то, и все. Этих знаний вам хватит, чтобы полностью понять дальнейшние главы и даже самим вычислять асимптотику многих алгоритмов. Далее мы рассмотрим еще несколько приемов на конкрентных алгоритмах.