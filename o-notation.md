...
В итоге, мы получили 3 главных множества функций - степенные, логарифмические и экспоненциальные. Для того, чтобы вы оценили, как они себя ведут на реальных цифрах, сейчас мы посчитаем значения некоторых из них в разных точках. Начнем с логарифмов. 

Рассмотрим самый обычный $$log_2(n)$$ и посчитаем его значения в точках $$n = 10$$, $$100$$, $$1000$$, $$10^6$$. Получаем, $$log_2(10) \approx 3$$, $$log_2(100) \approx 6$$, $$log_2(1000) \approx 10$$, $$log_2(10^6) \approx 20$$. Числа говорят сами за себя - логарифм **очень** быстрый, поэтому вы еще не раз встретите его в оценках сложностей алгоритмов.
